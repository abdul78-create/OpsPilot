...
import {
  ...
  Layers, GitBranch, Server, Activity, MailCheck, Check,
} from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError((data.message as string) || `HTTP ${res.status}: Registration failed. Try another email.`);
        return;
      }
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              We have provisioned your account for <span className="font-bold text-[var(--text-primary)]">{registeredEmail}</span>.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[var(--text-muted)] text-[11px] leading-relaxed">
              If email verification is enabled on your backend instance, check your inbox. You can now proceed to the sign-in page to access your workspace.
            </p>
          </div>
        ...
        <div className="space-y-8 z-10 my-auto">
          <div className="space-y-3">
            ...
            <p className="text-sm max-w-md leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              Get started with an autonomous DevOps workspace. Connect your first repository and orchestrate your pipeline today.
            </p>
          </div>
          ...
          <div className="space-y-3 max-w-lg">
            {ONBOARDING_ROADMAP.map((item) => (
              ...
              >
                ...
                <div>
                  <div className="font-bold text-xs" style={{ color: 'var(--text-primary)' }}>{item.title}</div>
        ...
        <div className="w-full max-w-md mx-auto my-auto space-y-6 py-6">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="flex items-start gap-2 pt-1">
              ...
              />
              <label htmlFor="agree-terms" className="text-xs cursor-pointer select-none" style={{ color: 'var(--text-secondary)' }}>
                I agree to the <Link href="/docs" className="underline hover:text-[var(--text-primary)]">Terms of Service</Link> and <Link href="/docs" className="underline hover:text-[var(--text-primary)]">Security Policy</Link>.
              </label>
            </div>
