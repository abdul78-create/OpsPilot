...
import { MetricsController } from '../src/v1/modules/observability/controllers/metrics.controller';
import { MetricsService } from '../src/v1/modules/observability/services/metrics.service';
import { HealthMonitoringController } from '../src/v1/modules/observability/controllers/health-monitoring.controller';
import { HealthMonitoringService } from '../src/v1/modules/observability/services/health-monitoring.service';
import { PrismaService } from '../src/core/database/prisma.service';
import { ConfigService } from '@nestjs/config';
import { JwtAuthGuard } from '../src/core/security/guards/jwt-auth.guard';
import { TenantGuard } from '../src/core/security/guards/tenant.guard';
